        ...
        */
        ...
        public void placeOrder(int id, Contract contract, Order order)
        {
            ...
            if (serverVersion >= MinServerVer.UNDER_COMP)
            {
                ...
                {
                    var underComp = contract.UnderComp;
        ...
        private string TagValueListToString(IEnumerable<ITwsTagValue> tagValues)
        {
            StringBuilder tagValuesStr = new StringBuilder();

            foreach (var tag in tagValues)
            {
                tagValuesStr.Append(tag.Tag).Append("=").Append(tag.Value).Append(";");
            }
