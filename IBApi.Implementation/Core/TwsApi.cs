...
namespace IBApi
{
    public class TwsApi : EWrapper, ITwsApi, IDisposable
    {
        ...
        public void reqMktDepth2(int id, string localSymbol, string secType, string exchange, string curency, int numRows, ITwsTagValueList options)
        {
        ...
        public void reqMktDataEx(int tickerId, ITwsContract contract, string genericTicks, bool snapshot, ITwsTagValueList options)
        {
            this.socket.reqMktData(tickerId, (Contract)contract, genericTicks, snapshot, ITagValueListToListTagValue(options));
        }

        private static List<TagValue> ITagValueListToListTagValue(ITagValueList tagList)
        {
            if (tagList == null)
                return null;

            List<TagValue> newList = new List<TagValue>();            
             
            for (int i = 0; i < tagList.Count; i++)
            {
                newList.Add((TagValue)tagList[i]);
            }
        ...
        public void reqMktDepthEx(int tickerId, ITwsContract contract, int numRows, ITwsTagValueList options)
        {
        ...
        public void reqRealTimeBarsEx(int tickerId, ITwsContract contract, int barSize, string whatToShow, bool useRTH, ITwsTagValueList options)
        {
            this.socket.reqRealTimeBars(tickerId, (Contract)contract, barSize, whatToShow, useRTH, ITagValueListToListTagValue(options));
        }


        public void reqScannerSubscriptionEx(int tickerId, ITwsScannerSubscription subscription, ITwsTagValueList options)
        {
        ...
        public ITwsComboLegList createComboLegList() { return new ComboLegList(); }
        ...
        public ITwsTagValueList createTagValueList() { return new TagValueList(); }

        public ITwsOrderComboLegList createOrderComboLegList() { return new OrderComboLegList(); }
        #endregion
        ...
        List<ITwsComboLeg> comboLegs = new List<ITwsComboLeg>();
        List<ITwsOrderComboLeg> orderComboLegs = new List<ITwsOrderComboLeg>();
...
#warning            var t_TwsConnectionTime = this.TwsConnectionTime;
        ...
        void ITws.reqMktDataEx(int tickerId, IContract contract, string genericTicks, bool snapshot, ITagValueList options)
        {
            socket.reqMktData(tickerId, (Contract)contract, genericTicks, snapshot, ITagValueListToListTagValue(options));
        }
        ...
        void ITws.exerciseOptionsEx(int tickerId, IContract contract, int exerciseAction, int exerciseQuantity, string account, int @override)
        {
            this.socket.exerciseOptions(tickerId, (Contract)contract, exerciseAction, exerciseQuantity, account, @override);
        }

        void ITws.reqHistoricalDataEx(int tickerId, IContract contract, string endDateTime, string duration, string barSize, string whatToShow, bool useRTH, int formatDate, ITagValueList options)
        {
            this.socket.reqHistoricalData(tickerId, (Contract)contract, endDateTime, duration, barSize, whatToShow, useRTH ? 1 : 0, formatDate, ITagValueListToListTagValue(options));
        }
        ...
        void ITws.reqMktData(int id, string symbol, string secType, string expiry, double strike, string right, string multiplier, string exchange, string primaryExchange, string currency, string genericTicks, bool snapshot, ITagValueList options)
        {
            Contract contract = new Contract();
        ...
        void ITws.reqMktData2(int id, string localSymbol, string secType, string exchange, string primaryExchange, string currency, string genericTicks, bool snapshot, ITagValueList options)
        {
            // set contract fields
            Contract contract = new Contract();
        ...
        void ITws.reqMktDepth(int id, string symbol, string secType, string expiry, double strike, string right, string multiplier, string exchange, string curency, int numRows, ITagValueList options)
        {
            // set contract fields
            Contract contract = new Contract();
        ...
        void ITws.reqHistoricalData(int id, string symbol, string secType, string expiry, double strike, string right, string multiplier, string exchange, string curency, int isExpired, string endDateTime, string durationStr, string barSizeSetting, string whatToShow, int useRTH, int formatDate, ITagValueList options)
        {
            Contract contract = new Contract();
        ...
        void ITws.reqScannerSubscription(int tickerId, int numberOfRows, string instrument, string locationCode, string scanCode, double abovePrice, double belowPrice, int aboveVolume, double marketCapAbove, double marketCapBelow, string moodyRatingAbove, string moodyRatingBelow, string spRatingAbove, string spRatingBelow, string maturityDateAbove, string maturityDateBelow, double couponRateAbove, double couponRateBelow, int excludeConvertible, int averageOptionVolumeAbove, string scannerSettingPairs, string stockTypeFilter, ITagValueList options)
        {
            ScannerSubscription subscription = new ScannerSubscription();
        ...
        void ITws.reqRealTimeBars(int tickerId, string symbol, string secType, string expiry, double strike, string right, string multiplier, string exchange, string primaryExchange, string currency, int isExpired, int barSize, string whatToShow, int useRTH, ITagValueList options)
        {
        ...
        IComboLegList ITws.createComboLegList()
        {
            return new ComboLegList();
        }
        ...
        ITagValueList ITws.createTagValueList()
        {
            return new TagValueList();
        }

        IOrderComboLegList ITws.createOrderComboLegList()
        {
            return new OrderComboLegList();
        }
