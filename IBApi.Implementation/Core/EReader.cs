    ...
    class EReader
    {
        ...
        private void BondContractDetailsEvent()
        {
            ...
            if (msgVersion >= 5)
            {
                ...
                if (secIdListCount > 0)
                {
                    contract.SecIdList = new List<ITwsTagValue>();
        ...
        private void OpenOrderEvent()
        {
            ...
            if (msgVersion >= 29)
            {
                ...
                if (comboLegsCount > 0)
                {
                    contract.ComboLegs = new List<ITwsComboLeg>(comboLegsCount);
                ...
                {
                    order.OrderComboLegs = new List<ITwsOrderComboLeg>(orderComboLegsCount);
            ...
            if (msgVersion >= 26)
            {
                ...
                {
                    order.SmartComboRoutingParams = new List<ITwsTagValue>(smartComboRoutingParamsCount);
            ...
            if (msgVersion >= 21)
            {
                ...
                if (!Util.StringIsEmpty(order.AlgoStrategy))
                {
                    ...
                    {
                        order.AlgoParams = new List<ITwsTagValue>(algoParamsCount);
        ...
        private void ContractDataEvent()
        {
            ...
            if (msgVersion >= 7)
            {
                ...
                if (secIdListCount > 0)
                {
                    contract.SecIdList = new List<ITwsTagValue>(secIdListCount);
                    for (int i = 0; i < secIdListCount; ++i)
                    {
                        TagValue tagValue = new TagValue();
                        tagValue.Tag = ReadString();
