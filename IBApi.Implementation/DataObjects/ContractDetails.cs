...
namespace IBApi.Implementation
{
     ...
     */
    [ComVisible(true)]
    public class ContractDetails : ITwsContractDetails
    {
        ...
        private List<ITwsTagValue> secIdList;
        ...
        * @brief A list of contract identifiers that the customer is allowed to view.
         * CUSIP/ISIN/etc.
        */
        public List<ITwsTagValue> SecIdList
        {
       ...
       */
        ...
        */
        ...
        #region IContractDetails implementation
