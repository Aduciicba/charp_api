...
namespace IBApi.Implementation
{
     ...
     */
    [ComVisible(true)]
    public class Contract : ITwsContract
    {
        private int conId;
        ...
        private List<ITwsComboLeg> comboLegs;
        private ITwsUnderComp underComp;
        ...
        */
         ...
         * @sa ComboLeg
         */
        public List<ITwsComboLeg> ComboLegs
        {
         ...
         * @sa UnderComp
         */
        public ITwsUnderComp UnderComp
        {
        ...
        object TWSLib.IContract.comboLegs
        {
            ...
            get { return new ComboLegList(comboLegs); }

            [param: MarshalAs(UnmanagedType.IDispatch)]
            set { comboLegs = value is ComboLegList ? (value as ComboLegList).Ocl : null; }
        }
