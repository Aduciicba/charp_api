...
namespace IBApi.Implementation
{
    ...
    public class Order : ITwsOrder
    {
        ...
        private List<ITwsTagValue> algoParams;
        // What-if
        private bool whatIf;
        //algoId
        ...
        private List<ITwsTagValue> smartComboRoutingParams;
        // order combo legs
        private List<ITwsOrderComboLeg> orderComboLegs = new List<ITwsOrderComboLeg>();
        private List<ITwsTagValue> orderMiscOptions = new List<ITwsTagValue>();
        ...
        * @brief The list of parameters for the IB algorithm.
         * For more information about IB's API algorithms, refer to https://www.interactivebrokers.com/en/software/api/apiguide/tables/ibalgo_parameters.htm
        */
        public List<ITwsTagValue> AlgoParams
        {
        ...
        */
         ...
         */
        public List<ITwsTagValue> SmartComboRoutingParams
        {
        ...
        */
        public List<ITwsOrderComboLeg> OrderComboLegs
        {
            get { return orderComboLegs; }
            set { orderComboLegs = value; }
        }

        public List<ITwsTagValue> OrderMiscOptions
        {
        ...
        */
        ...
        { 
            get 
            { 
                return new TagValueList(algoParams); 
            }
 
            set 
            { 
                algoParams = value != null ? (value as TagValueList).Tvl : new List<ITwsTagValue>(); 
            } 
        }
        ...
        object TWSLib.IOrder.smartComboRoutingParams
        {
            get
            {
                return new TagValueList(smartComboRoutingParams);
            }

            set
            {
                smartComboRoutingParams = value != null ? (value as TagValueList).Tvl : new List<ITwsTagValue>();
            }
        }
        ...
        object TWSLib.IOrder.orderComboLegs
        {
            get
            {
                return new OrderComboLegList(orderComboLegs);
            }

            set
            {
                orderComboLegs = (value as OrderComboLegList).Ocl;
            }
        }
        ...
        object TWSLib.IOrder.orderMiscOptions
        {
            get
            {
                return new TagValueList(orderMiscOptions);
            }

            set
            {
                orderMiscOptions = value != null ? (value as TagValueList).Tvl : new List<ITwsTagValue>();
            }
        }
