...
namespace TWSLib
{
    ...
    public class TagValueList : ITagValueList
    {
        ...
        public List<IBApi.Implementation.TagValue> Tvl { get; private set; }

        public TagValueList() : this(new List<IBApi.Implementation.TagValue>()) { Tvl = new List<IBApi.Implementation.TagValue>(); }
        public TagValueList(List<IBApi.Implementation.TagValue> tvl)
        {
            this.Tvl = tvl == null ? new List<IBApi.Implementation.TagValue>() : tvl;
        }
        ...
        {
            var rval = new IBApi.Implementation.TagValue();
        ...
        {
            var rval = new IBApi.Implementation.TagValue(tag, value);
